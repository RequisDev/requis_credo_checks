defmodule RequisCredoChecks.AbsintheObjectPrefixTest do
  ...
  test "can exclude module with full prefix" do
    """
    defmodule TestModule.BadMock do
      @moduledoc false
      use Absinthe.Schema.Notation
    ...
    """
    |> to_source_file()
    |> AbsintheObjectPrefix.run(exclude_modules: [[:TestModule, :BadMock]])
    |> refute_issues()
  end

  test "can exclude module if the prefix exists in module name" do
    """
    defmodule TestModule.BadMock do
      @moduledoc false
      use Absinthe.Schema.Notation
    ...
    """
    |> to_source_file()
    |> AbsintheObjectPrefix.run(exclude_modules: [[:BadMock]])
    |> refute_issues()
  end
end
